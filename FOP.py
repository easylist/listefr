...
KNOWNOPTIONS = ("collapse", "csp", "document", "elemhide",
                ...
                "rewrite=abp-resource:rewrite=abp-resource:blank-css", "rewrite=abp-resource:rewrite=abp-resource:blank-js", "rewrite=abp-resource:rewrite=abp-resource:blank-html", "rewrite=abp-resource:rewrite=abp-resource:blank-mp3", "rewrite=abp-resource:rewrite=abp-resource:blank-text",
                "rewrite=abp-resource:rewrite=abp-resource:1x1-transparent-gif", "rewrite=abp-resource:rewrite=abp-resource:2x2-transparent-png", "rewrite=abp-resource:rewrite=abp-resource:3x2-transparent-png", "rewrite=abp-resource:rewrite=abp-resource:32x32-transparent-png",
